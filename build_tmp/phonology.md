...
|---|---|---|---|
| 1a | E1: elide C₁ | C₁ $\in$ {ɾ, dʒ, n, j, g, v} | C₀ V₁ V₂ C₂ → step 2 |
| 1b | M1: relocate C₁ if /ɻ/ | C₁ = /ɻ/ AND C₀ $\in$ {/h/, ∅} | rhotic moves to onset; /h/ becomes devoicing feature → /r̥/. Hiatus created. → step 2 |
...
| 4 | E3: elide V₂ | V₂ $\in$ elision set, intervocalic position not vacated | C₀ V₁ C₁ C₂ → step 5 |
| 4 | E3: skip | otherwise | → step 6 |
| 5 | Syllabic-C promotion | C₁ or C₂ $\in$ syllabic-eligible | C₀ V₁ C₁ C̩₂ (foot + appendix) |
| 6 | E2 family: coda treatment | C₂ subject to coda rules (E2a–E2d) | varies — see §4.4 |
| 7 | Final-V resolution | V₂ $\in$ {e, a, ə} | strengthen ə→a |
| 7 | Final-V resolution | V₂ $\in$ {i, o} | reduce to syllabic /j, w/ |
