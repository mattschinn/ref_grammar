...
- [~] **B2. Import draft translations.** *In progress.* Promote `/drafts` translation-exercise sentences into `examples.md` per the locked draft-import bar. **Pilot done 2026-06-28:** E020–E022 from Translation Exercise #2 (`drafts/translation_exercise_2/0615_transl_activity.converted.md`), all **[Provisional — review pending]**, corpus-only (not transcluded), with source pointers, stub-checks, and conflict flags (reconciled-to-canon, not overwritten). **Survey:** TX#2 holds ~40 glossed sentences; ~12 already are E001–E019, leaving ~25 candidates; other sources (`translation_exercise_1/`, `negatives_*`, `poetics.md`, `verb-concept-grids`) not yet surveyed. Multi-session; author reviews each batch. Pending author steer on pace + reconcile-to-canon-vs-verbatim.
